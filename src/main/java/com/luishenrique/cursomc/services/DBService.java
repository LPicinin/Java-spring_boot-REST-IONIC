...
import com.luishenrique.cursomc.domain.Cidade;
...
import com.luishenrique.cursomc.domain.enums.PerfilUsuario;
...
import com.luishenrique.cursomc.repositories.ItemPedidoRepository;
...
{
	@Autowired
	private BCryptPasswordEncoder passwordCryptEncoder;
	@Autowired
	...
	public void instantiateDatabase() throws ParseException
	{
		...
		Cliente cli1 = new Cliente(null, "Luís Henrique Picinin Jandre", "luishpj@outlook.com.br", "68253789025",
				TipoCliente.PESSOAFISICA, passwordCryptEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		
		Cliente cli2 = new Cliente(null, "Marlene Picinin Jandre", "mpicinin@hotmail.com", "46145247029",
				TipoCliente.PESSOAFISICA, passwordCryptEncoder.encode("1234"));
		cli2.addPerfil(PerfilUsuario.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("86456", "84615"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "563136", cli2, c2);
